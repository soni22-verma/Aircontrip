...
export default function PromoBanner() {
  return (
    <section className="px-4 sm:px-6 md:px-10 my-8">
      <div
        className="relative w-full h-[120px] sm:h-[160px] md:h-[100px]
                   rounded-xl overflow-hidden flex justify-center"
        style={{
          backgroundImage:
            "url('https://tpc.googlesyndication.com/simgad/15370050502381143377')", 
