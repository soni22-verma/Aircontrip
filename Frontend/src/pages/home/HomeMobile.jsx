          ...
          <div className=" absolute top-[15%] ">
            <div className="flex flex-nowrap justify-center items-center overflow-x-auto gap-3 scrollbar-hide">
              ...
              <button
                ...
                className=" border border-black px-2 py-3 bg-transparent  gap-2 font-bold text-white  text-sm   flex flex-col  items-center justify-center whitespace-nowrap   rounded-2xl"
              >
